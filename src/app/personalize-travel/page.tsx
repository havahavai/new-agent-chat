...
export const metadata: Metadata = {
  ...
  description:
    "Customize your Flyo personal travel assistant with your preferences, frequent destinations, and travel habits for a truly personalized booking experience.",
  keywords: [
  ...
  openGraph: {
    title: "Personalize Your Travel Assistant - Flyo Setup",
    description:
      "Customize your personal travel assistant with your preferences for a personalized booking experience.",
    url: "/personalize-travel",
  },
  twitter: {
    title: "Personalize Your Travel Assistant - Flyo Setup",
    description:
