...
export const metadata: Metadata = {
  ...
  description:
    "Confirm your profile details to complete your Flyo account setup. Verify your information for secure and personalized travel booking.",
  keywords: [
  ...
  openGraph: {
    title: "Confirm Your Profile - Complete Flyo Setup",
    description:
      "Complete your account setup by confirming your profile details for secure travel booking.",
